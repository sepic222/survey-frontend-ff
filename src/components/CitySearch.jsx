    ...
    <div className="w-full max-w-xl animate-slideUp">
      ...
      <div className="relative">
        <Autocomplete
          ...
          className="w-full bg-black border-2 border-zinc-700 rounded-lg p-4 text-xl text-white focus:border-cyan-400 focus:bg-zinc-900 outline-none transition-all duration-300 placeholder-zinc-600"
